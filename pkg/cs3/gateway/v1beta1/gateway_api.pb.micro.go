...
import (
	...
	v1beta15 "github.com/refs/cs3-micro/pkg/cs3/app/registry/v1beta1"
	v1beta17 "github.com/refs/cs3-micro/pkg/cs3/auth/registry/v1beta1"
	v1beta16 "github.com/refs/cs3-micro/pkg/cs3/identity/user/v1beta1"
	v1beta12 "github.com/refs/cs3-micro/pkg/cs3/preferences/v1beta1"
	_ "github.com/refs/cs3-micro/pkg/cs3/rpc/v1beta1"
	v1beta11 "github.com/refs/cs3-micro/pkg/cs3/sharing/collaboration/v1beta1"
	v1beta13 "github.com/refs/cs3-micro/pkg/cs3/sharing/link/v1beta1"
	v1beta14 "github.com/refs/cs3-micro/pkg/cs3/sharing/ocm/v1beta1"
	v1beta1 "github.com/refs/cs3-micro/pkg/cs3/storage/provider/v1beta1"
	v1beta18 "github.com/refs/cs3-micro/pkg/cs3/storage/registry/v1beta1"
...
type GatewayAPIService interface {
	...
	GetHome(ctx context.Context, in *v1beta18.GetHomeRequest, opts ...client.CallOption) (*v1beta18.GetHomeResponse, error)
}
...
func (c *gatewayAPIService) GetHome(ctx context.Context, in *v1beta18.GetHomeRequest, opts ...client.CallOption) (*v1beta18.GetHomeResponse, error) {
	req := c.c.NewRequest(c.name, "GatewayAPI.GetHome", in)
	out := new(v1beta18.GetHomeResponse)
	err := c.c.Call(ctx, req, out, opts...)
	if err != nil {
		return nil, err
	}
...
type GatewayAPIHandler interface {
	...
	// Returns the home path for the given authenticated user.
	// When a user has access to multiple storage providers, one of them is the home.
	GetHome(context.Context, *v1beta18.GetHomeRequest, *v1beta18.GetHomeResponse) error
}
...
func RegisterGatewayAPIHandler(s server.Server, hdlr GatewayAPIHandler, opts ...server.HandlerOption) error {
	type gatewayAPI interface {
		...
		GetHome(ctx context.Context, in *v1beta18.GetHomeRequest, out *v1beta18.GetHomeResponse) error
	}
...
func (h *gatewayAPIHandler) GetHome(ctx context.Context, in *v1beta18.GetHomeRequest, out *v1beta18.GetHomeResponse) error {
